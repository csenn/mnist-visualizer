...
export default class LineChart extends React.Component {
  ...
  componentWillUmount() {
    const domNode = this.chartBox.current;
  ...
  _renderChart() {
    ...
    const xScale = d3.scale
      .linear()
      .range([0, width])
      .domain([-0.5, labels.length - 1 + 0.5]);
    ...
    const colorFunc = d3.scale.category10().domain(labels);
  ...
  render() {
    return <div style={{ position: "relative" }} ref={this.chartBox}></div>;
  }
}
