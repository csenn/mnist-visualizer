...
class Main extends React.Component {
  constructor(props) {
    ...
    props.dispatch(
      getNetwork("eta_.1_hidden_20_15_crossEntropy_improvedWeights_tanh.json"),
    );
  }
...
const mapStateToProps = (state) => {
  ...
  if (selectedSnapshot) {
    ...
    testResultsSummary = Object.keys(testResults).reduce((prev, curr) => {
      const wrongCount = _.values(testResults[curr].wrong).reduce(
        (prev1, curr2) => prev1 + curr2.length,
        0,
      );
